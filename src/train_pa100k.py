...
def main(cfg, args):
    ...
    timestamp = time_str()
    stdout_file = os.path.join(log_dir, f'stdout_multi_evavit_swinT_pa100k.txt')
    save_model_path = os.path.join(model_dir, f'ckpt_max_multi_evavit_swinT_pa100k.pth')
