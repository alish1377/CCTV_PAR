...
_C.RELOAD.PTH = 'best_model.pth'
_C.RELOAD.BEST_PRETRAINED_WEIGHT = ''
_C.RELOAD.PRETRAINED_FLAG = True
_C.RELOAD.FREEZE = False
_C.RELOAD.PARTIAL_FINE_TUNING = False
_C.RELOAD.CONTINUE_CONVNEXT = False
_C.RELOAD.MODEL_FOLDER_NAME = 'pretrained_model'
_C.RELOAD.ADAPTFORMER = False

_C.RELOAD.ADAPTFORMER = True
_C.RELOAD.HALFADAPTRATIO = 0.5
...
_C.DATASET.TRAIN_NATIVE_SPLIT = 0.0
_C.DATASET.VAL_NATIVE_SPLIT = 1.0
_C.DATASET.TEST_NATIVE_SPLIT = 0.0

_C.DATASET.PHASE1_ROOT_PATH =  'data/phase1/annotations/phase1/'
_C.DATASET.PHASE2_ROOT_PATH = 'data/phase2/'
_C.DATASET.ROOT_PATH = 'data/phase2/'

_C.DATASET.IMAGE_PATH = None
_C.DATASET.ALL_ATTRS = None
_C.DATASET.ATTRS = None
_C.DATASET.COLOR_ATTRS = None
_C.DATASET.OTHER_ATTRS = None
_C.DATASET.WHICH_ATTRS = None
_C.DATASET.NATIVE_EXCEL = "/content/upar_challenge/data/NATIVE/Native_dataset.xlsx"
_C.DATASET.REMOVE_LOW_QUALITY = False


# ----- BACKBONE BUILDER -----
_C.BACKBONE = CN()
_C.BACKBONE.TYPE = "resnet50"
_C.BACKBONE.MULTISCALE = True
...
# ----------- Testing -------------
_C.TEST = CN()
_C.TEST.MODEL_FOLDER_NAME = "pretrained_model"  # Name of the model folder (in exp_result/NATIVE directory)
_C.TEST.PRETRAINED_WEIGHTS = "best_model.pth"   # Name of the pretrained weight
_C.TEST.VIDEO_NAME = "video1"   # video name ("VIDEO_NAME.mp4")
_C.TEST.VIDEO_PATH = "test_videos"  # This folder contains the test input videos
_C.TEST.OUTPUT_VIDEO_PATH = "results_videos"  # This folder contains the test result videos
_C.TEST.YOLO_MODEL = "yolov8n.pt"  # The detection model
_C.TEST.YOLO_CONF = 0.3   # Confidence threshold for Yolo model
_C.TEST.CHECK_PER_FRAME = 2   # Specify how many frames this flag should be checked once.
